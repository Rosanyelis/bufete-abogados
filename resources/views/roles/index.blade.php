                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li class="nk-block-tools-opt">
                                                    @can('role.create')
                                                    <a href="{{ route('role.create') }}" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                                    <a href="{{ route('role.create') }}" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Agregar Rol</span></a>
                                                    @endcan
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <form id="formDelete-{{ $item->id }}" action="{{ route('role.destroy', ['id' => $item->id]) }}"method="POST">
                                                                            @csrf
                                                                        </form>
        ...
        <script>
            (function(NioApp, $){
                ...
                $('.datatable-init tbody').on('click', '.delete-record', function(){
                    ...
                    Swal.fire({
                        title: '¿Está Seguro de Eliminar el Role?',
